...
function createInitElems() {
        ...
        gpuDiv = document.createElement("div");
        uiForm = document.createElement("form");
        brand = createSelect({
            defText:"Choose your Fighter",
            arr:["AMD","Intel"],
            id:"brandSelect",
        ...
        codeName = document.createElement("input");
        msrp = document.createElement("input");
      
        uiForm.id = "uiForm";
        msrp.type = "number";

        uiForm.innerHTML += "Brand:";
        uiForm.appendChild(brand);
        uiForm.innerHTML += "Product Name:"
        uiForm.appendChild(product);
        uiForm.innerHTML += "Code Name:"
        uiForm.appendChild(codeName);
        uiForm.innerHTML += "MSRP:"
        uiForm.appendChild(msrp);

        uiDiv.appendChild(uiForm);
        
        initDiv.appendChild(uiDiv);
        initDiv.appendChild(gpuDiv);
